    ...
    return (
        <div className="relative flex h-full w-[221px] flex-col rounded-xl bg-white bg-clip-border p-2">
            ...
            <nav className="w-full h-full justify-start items-center flex flex-col">
                ...
                <NavigationButton text="Investment" Icon={FaChartPie} route="/Investment" />
                ...
                <div
                    className="w-[200px] h-[43px] flex items-center justify-start px-2 rounded-[20px] text-[#1C1C26] transition-colors duration-200 cursor-pointer mb-2 hover:bg-red-800 hover:text-white"
